    ...
    <div class='container-fluid'>
        <div class='row-fluid'>
            <div class='span12 box bordered-box orange-border' style='margin-bottom:0;'>
                ...
                <!-- 搜索 -->
                <div class="row-fluid">
                    <form class="form form-horizontal" action="<?php echo U('/admin/know');?>" accept-charset="utf-8" method="get">
                        ...
                        <div class="btn btn-default" onclick="to_url('<?php echo U('/admin/know');?>')">全部</div>
                ...
                <div class="modal hide fade" id="modal-example2" role="dialog" tabindex="-1" style="display: none;" aria-hidden="true">
                    ...
                    <div class="modal-body">
                        <form class='form form-horizontal validate-form' style='margin-bottom: 0;'
                              action="<?php echo U('/admin/know/add');?>" method="post" />
                        <div class='control-group'>
                            <label class='control-label' for='title'>文章标题</label>
                            <div class='controls'>
                                <input data-rule-minlength='1' data-rule-required='true'  name='title' placeholder='输入文章标题' type='text' />
                            </div>
                        </div>
                ...
                <div class='box-content box-no-padding'>
                    <table class='table table-striped' style='margin-bottom:0;'>
                        ...
                        <?php if(is_array($knows)): foreach($knows as $key=>$v): ?><tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-link has-tooltip" href="#" onclick="to_url_delete('<?php echo U('/admin/'.$nav.'/delete/table/know/id/'.$v['id']);?>',this)" data-original-title="删除">
