	...
	<div class='container-fluid'>
		<div class='row-fluid'>
			<div class='span12 box bordered-box orange-border' style='margin-bottom:0;'>
				...
				<!-- 搜索 -->
				<div class="row-fluid">
					<form class="form form-horizontal" action="<?php echo U('/admin/members');?>" accept-charset="utf-8" method="get">
						<input name="id" value="<?php echo ($id); ?>" placeholder="按id搜索" class="form-control" type="text">
						<input name="username" value="<?php echo ($username); ?>" placeholder="按用户名搜索" class="form-control" type="text">
						<button class="btn btn-default" type="submit">搜索</button>
						<div class="btn btn-default" onclick="to_url('<?php echo U('/admin/members');?>')">全部</div>
				...
				<div class="modal hide fade" id="modal-example2" role="dialog" tabindex="-1" style="display: none;" aria-hidden="true">
					...
					<div class="modal-body">
						<form class='form form-horizontal validate-form' style='margin-bottom: 0;'
						      action="<?php echo U('/admin/members/add');?>" method="post" />
				...
				<div class='box-content box-no-padding'>
					<table class='table table-striped' style='margin-bottom:0;'>
						...
						<?php if(is_array($managers)): foreach($managers as $key=>$v): ?><tr>
								<td width=""><?php echo ($v["id"]); ?></td>
								<td width=""><?php echo ($v["username"]); ?></td>
								<td width=""><?php echo ($v["realname"]); ?></td>
								<!--<td width="">-->
								...
								<td>
									<?php if ($v['username'] != 'admin') { ?>
									<a class="btn btn-link has-tooltip" href="#" onclick="to_url_delete('<?php echo U('/admin/members/delete/table/managers/id/'.$v['id']);?>',this)" data-original-title="删除">
