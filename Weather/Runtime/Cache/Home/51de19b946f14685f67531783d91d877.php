...
<body>
    ...
    <div class="wrap wrap_white">
        <div class="container title">
            <h1 class="title__h1 underscore">果树小气候实况监测报警信息</h1>
        </div>
    </div>
    <!-- END title -->
                ...
                <div class="wrap-thumbnail">
                    <div class="thumbnail">
                        <div class="thumbnail__news news">
                            <div>
                                <form action="/fruitwarning" class="form-inline" id="wtform" method="post">
                            ...
                            <table class="table table-striped table-hover table-bordered">
                                ...
                                <?php if(is_array($cold)): foreach($cold as $key=>$v): ?><tr>
                                        ...
                                        <td>当前室外气温过低，部分果树将遭受冷害影响，请视具体情况适当采取御寒保温措施</td>
                                        <td><?php echo ($v['plantdis']); ?></td>
                                    </tr><?php endforeach; endif; ?>
                                <?php } else { ?>
                                <tr>
                                    <td>没有受害果树</td>
                                    <!--<td>当前室内气温过低，部分农果树将遭受冻害影响，请视具体情况适当采取御寒保温措施</td>-->
                                    <!--<td>没有受害果树</td>-->
                                </tr>
                                <?php } ?>
                                </tbody>
                            ...
                            <table class="table table-striped table-hover table-bordered">
                                ...
                                <?php if(is_array($ice)): foreach($ice as $key=>$v): ?><tr>
                                        <td><?php echo ($v['dis']); ?></td>
                                        <td>当前室外气温过低，部分果树将遭受霜冻影响，请视具体情况适当采取御寒保温措施</td>
                                        <td><?php echo ($v['plantdis']); ?></td>
                                    </tr><?php endforeach; endif; ?>
                                <?php } else { ?>
                                <tr>
                            ...
                            <table class="table table-striped table-hover table-bordered">
                                ...
                                <?php if(is_array($hot)): foreach($hot as $key=>$v): ?><tr>
                                        <td>当前室内气温过高，部分果树将受到热害影响，请视具体情况适当采取通风、喷水、浇灌等降温措施</td>
                                        <td><?php echo ($v['plantdis']); ?></td>
                                    </tr><?php endforeach; endif; ?>
                                <?php } else { ?>
                                <tr>
                                    <!--<td>当前室内气温过高，部分农果树将受到热害影响，请视具体情况适当采取通风、喷水、浇灌等降温措施</td>-->
                                    <td>没有受害果树</td>
                                </tr>
                                <?php } ?>
                                </tbody>
