                    ...
                    <div class="container">
                        ...
                        <div class="brilliant-grids">
                            ...
                            <div class="col-md-3 brilliant-grid">
                                <div class="brilliant-left">
                                    <a href="/nyservice"><i class="glyphicon glyphicon-cloud" aria-hidden="true"></i></a>
                                </div>
                                <div class="brilliant-right">
                                    <a href="/nyservice"><h4>农业气象服务信息</h4></a>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                            <!--<div class="col-md-4 brilliant-grid">-->
            ...
            <section>
                ...
                <div class="wrap wrap_white">
                    <div class="container title">
                        <h1 class="title__h1 underscore">最新天气实况</h1>
                    </div>
                </div>
                ...
                <div class="wrap wrap_gray pt20">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                    <div class="col-md-12 col-sm-12" id="out" style="height:500px">
                            ...
                            <div>
                                ...
                                <table class="table table-striped table-hover table-bordered">
                                    ...
                                    <tbody id="skyt">
                                        <tr>
                                            <?php if(is_array($sky)): foreach($sky as $key=>$v): ?><td><?php echo ($v['time']); ?></td><?php endforeach; endif; ?>

                                        </tr>
                                        <tr>
                                            <?php if(is_array($sky)): foreach($sky as $key=>$v): ?><td align="center" style="width: 60px; height: 60px;"><img height="50" width="50" src="/Public/assets/images/picweather/<?php echo ($v['icon']); ?>" alt="" /></td><?php endforeach; endif; ?>
...
//                                boundaryGap: false,
                ...
                if (data.sky) {
                    var str = '';
                    str += "<tr><td>" + data.sky[0]['time'] + "</td>";
                    str += "<td>" + data.sky[1]['time'] + "</td>";
                    str += "<td>" + data.sky[2]['time'] + "</td></tr>";

                    str += '<tr><td align="center" style="width: 60px; height: 60px;"><img height="50" width="50" src="/Public/assets/images/picweather/' + data.sky[0]['icon'] + '" alt="" /></td>';
                    str += '<td align="center" style="width: 60px; height: 60px;"><img height="50" width="50" src="/Public/assets/images/picweather/' + data.sky[1]['icon'] + '" alt="" /></td>';
                    str += '<td align="center" style="width: 60px; height: 60px;"><img height="50" width="50" src="/Public/assets/images/picweather/' + data.sky[2]['icon'] + '" alt="" /></td></tr>';
