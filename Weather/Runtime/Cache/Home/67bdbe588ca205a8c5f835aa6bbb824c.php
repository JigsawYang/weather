...
<body>
        ...
        <div class="wrap wrap_white">
            <div class="container title">
                <h1 class="title__h1 underscore">温室内小气候实时监测数据</h1>
            </div>
        </div>
        <!-- END title -->
                            ...
                            <div class="thumbnail__news news">
                                ...
                                <div class="table-responsive">
                                    <div>
                                        <div class="btn-group pull-right" id="templatemo_sort_btn">
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                                ...
                                                <li>
                                                    <a href="/livedata/show_table/station/<?php echo ($v['id']); ?>.html"><?php echo ($v['location']); ?>--<?php echo ($v['zdmc']); ?></a>
                                                </li>
                                                <?php } ?>
                                    ...
                                    <table class="table table-striped table-hover table-bordered">
                                        ...
                                        <tr>
                                            <th></th>
                                            <th colspan="3">空气温度</th>
                                            <th colspan="3">空气湿度</th>
                                            <th colspan="3">土壤温度</th>
                                            <th colspan="3">土壤湿度</th>
                                            <th colspan="2">太阳总辐射</th>
                                            <th colspan="2">太阳有效辐射</th>
                                            <th colspan="2">二氧化碳浓度</th>
                                        </tr>
                                        ...
                                        <tr>
                                            <td>150厘米</td>
                                            <td><?php echo ($tmpnow150); ?></td>
                                            <td><?php echo ($tmp['max150']); ?></td>
                                            <td><?php echo ($tmp['min150']); ?></td>
                                            <td><?php echo ($air_wet_now); ?></td>
                                            <td><?php echo ($air['max150']); ?></td>
                                            <td><?php echo ($air['min150']); ?></td>
                                            <td></td>
                                            <td></td>
                                            <td></td>
                                            <td></td>
                                            <td></td>
                                            <td></td>
                                            <td><?php echo ($sunall); ?></td>
                                            <td><?php echo ($sun['maxall']); ?></td>
                                            <td><?php echo ($sunpar); ?></td>
                                            <td><?php echo ($sun['maxpar']); ?></td>
                                            <td><?php echo ($co2['maxco2']); ?></td>
                                            <td></td>
                                        </tr>
                                        <tr>
                                            <td>100厘米</td>
                                            <td><?php echo ($tmpnow100); ?></td>
                                            <td><?php echo ($tmp['max100']); ?></td>
                                            <td><?php echo ($tmp['min100']); ?></td>
                                            <td></td>
                                            <td></td>
                                            <td></td>
                                            <td></td>
                                        ...
                                        <tr>
                                            ...
                                            <td></td>
                                            <td></td>
                                            <td><?php echo ($ldair_now_0); ?></td>
                                            <td><?php echo ($ldair['max0']); ?></td>
                                            <td><?php echo ($ldair['min0']); ?></td>
                                            <td></td>
                                            <td></td>
                                            <td></td>
                                            <td></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo ($ldair_now_10); ?></td>
                                            <td><?php echo ($ldair['max10']); ?></td>
                                            <td><?php echo ($ldair['min10']); ?></td>
                                            <td><?php echo ($ldwet_now_10); ?></td>
                                            <td><?php echo ($ldwet['max10']); ?></td>
                                            <td><?php echo ($ldwet['min10']); ?></td>
                                            <td></td>
                                            <td></td>
                                            <td></td>
                                            <td></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo ($ldair_now_20); ?></td>
                                            <td><?php echo ($ldair['max20']); ?></td>
                                            <td><?php echo ($ldair['min20']); ?></td>
                                            <td><?php echo ($ldwet_now_20); ?></td>
                                            <td><?php echo ($ldwet['max20']); ?></td>
                                            <td><?php echo ($ldwet['min20']); ?></td>
                                            <td></td>
                                            <td></td>
                                            <td></td>
                                            <td></td>
                                        ...
                                        <tr>
                                            ...
                                            <td></td>
                                            <td></td>
                                            <td><?php echo ($ldwet_now_30); ?></td>
                                            <td><?php echo ($ldwet['max30']); ?></td>
                                            <td><?php echo ($ldwet['min30']); ?></td>
                                            <td></td>
                                            <td></td>
                                            <td></td>
                                            <td></td>
