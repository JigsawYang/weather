...
(function ($, window) {
    $.fn.sdkFocus = function (options) {
        var object = $(this).find('input[type="text"],input[type="email"],input[type="password"]');

        object.bind('focus', function() {
            var placeholder = $(this).attr('placeholder');
            $(this).attr('placeholder', '');
            var html = '<div class="placeholder">'+placeholder+'</div>';
            $(this).parent().append(html);
        });

        object.bind('blur', function() {
            var placeholder = $(this).parent().find('.placeholder');
            $(this).attr('placeholder', placeholder.html());
            placeholder.remove();
        });
    };
